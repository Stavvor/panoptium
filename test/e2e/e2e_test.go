...
const namespace = "panoptium-system"

// serviceAccountName created for the project
const serviceAccountName = "panoptium-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "panoptium-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "panoptium-metrics-binding"
